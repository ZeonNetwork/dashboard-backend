...
export default {
  app: {
    ...
    companyName: COMPANY_NAME || 'ZEON Network',
  ...
  email: {
    domain: MAILGUN_DOMAIN || 'zeon.network',
    mailgun: {
    ...
    from: {
      general: EMAIL_FROM || 'noreply@zeon.network',
      referral: EMAIL_REFERRAL || 'partners@zeon.network'
    },
    template: {
